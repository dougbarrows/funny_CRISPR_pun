...
user_bed_path = "Homo_sapiens.GRCh38.98.chromosome.9.TSS.genesofinterest.bed.txt"
guide_loc_path ="chr9_UCSCtable_35k.txt" 
output_name = "demo_files_test_35K_1158"
upstream = 100 
downstream = 100 
sort_by = "Doench2016_perc"
de_novo = False
cloning_strategy = "pX330"

range_overlap(user_bed_path, guide_loc_path, output_name, upstream , downstream , sort_by, de_novo, cloning_strategy)
